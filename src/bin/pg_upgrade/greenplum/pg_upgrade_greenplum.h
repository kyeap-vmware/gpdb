...
#define GREENPLUM_OPTIONS \
	...
	{"migrate-checks", no_argument, NULL, GREENPLUM_MIGRATE_CHECKS},
...
#define GREENPLUM_USAGE "\
  ...
  --migrate-checks              run only the subset of checks applicable for cluster migration using gpbackup.\"\n\
"
