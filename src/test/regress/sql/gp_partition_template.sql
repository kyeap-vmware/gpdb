...
-- test pg_get_expr WITH tablename
CREATE TABLE public.sales0 (
    trans_id integer,
    date date,
    region text
)
PARTITION BY RANGE(date) DISTRIBUTED BY (trans_id);

CREATE TABLE public.sales0_1_prt_2 (
    trans_id integer,
    date date,
    region text
)
PARTITION BY LIST (region) DISTRIBUTED BY (trans_id);

ALTER TABLE ONLY public.sales0 ATTACH PARTITION public.sales0_1_prt_2 FOR VALUES FROM ('2023-01-01'::date) TO ('2023-05-01'::date);

CREATE TABLE public.sales0_1_prt_2_2_prt_europe ( trans_id integer, date date, region text)
DISTRIBUTED BY (trans_id);

ALTER TABLE ONLY public.sales0_1_prt_2 ATTACH PARTITION public.sales0_1_prt_2_2_prt_europe FOR VALUES IN ('europe'::text);

CREATE TABLE public.sales0_1_prt_2_2_prt_asia (
        trans_id integer,
        date date,
        region text
        )
...
ALTER TABLE ONLY public.sales0_1_prt_2 ATTACH PARTITION public.sales0_1_prt_2_2_prt_asia FOR VALUES IN ('asia'::text);

ALTER TABLE public.sales0
SET SUBPARTITION TEMPLATE
(
    SUBPARTITION usa VALUES('usa') WITH (tablename='sales0'),
    SUBPARTITION asia VALUES('asia') WITH (tablename='sales0'),
    SUBPARTITION europe VALUES('europe') WITH (tablename='sales0'),
    DEFAULT SUBPARTITION other_regions  WITH (tablename='sales0')
);

SELECT pg_get_expr(template, relid) from gp_partition_template where relid='sales0'::regclass::oid;

ALTER TABLE ONLY public.sales0 DETACH PARTITION public.sales0_1_prt_2;
DROP TABLE sales0;

CREATE TABLE public."sales'0" (
    trans_id integer,
    date date,
    region text
)
...
ALTER TABLE ONLY public."sales'0" ATTACH PARTITION public.sales0_1_prt_2 FOR VALUES FROM ('2023-01-01'::date) TO ('2023-05-01'::date);

ALTER TABLE public."sales'0"
SET SUBPARTITION TEMPLATE
(
    SUBPARTITION usa VALUES('usa') WITH (tablename='sales''0'),
    SUBPARTITION asia VALUES('asia') WITH (tablename='sales''0'),
    SUBPARTITION europe VALUES('europe') WITH (tablename='sales''0'),
    DEFAULT SUBPARTITION other_regions  WITH (tablename='sales''0')
);

SELECT pg_get_expr(template, relid) from gp_partition_template where relid='sales''0'::regclass::oid;
DROP TABLE "sales'0";
-- end test pg_get_expr
