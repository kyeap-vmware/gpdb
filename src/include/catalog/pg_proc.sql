...
CREATE FUNCTION gp_create_restore_point(text) RETURNS pg_lsn LANGUAGE internal IMMUTABLE STRICAT AS 'gp_create_restore_point' WITH (OID=6998,  DESCRIPTION="Create a named restore point on all segments");
