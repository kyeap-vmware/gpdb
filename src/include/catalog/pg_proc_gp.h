...
/* create_distributed_restore_point() => int8 */
DATA(insert OID = 6998 ( create_distributed_restore_point  PGNSP PGUID 12 1 0 0 0 f f f f t f i 0 0 20 "" _null_ _null_ _null_ _null_ _null_ create_distributed_restore_point _null_ _null_ _null_ n a ));
DESCR("Distributed restore point function");

/* create_distributed_restore_point_on_segments(int8) => void */
DATA(insert OID = 6999 ( create_distributed_restore_point_on_segments  PGNSP PGUID 12 1 0 0 0 f f f f t f i 1 0 2278 "20" _null_ _null_ _null_ _null_ _null_ create_distributed_restore_point_on_segments _null_ _null_ _null_ n a ));
DESCR("Distributed restore point function on segments");
