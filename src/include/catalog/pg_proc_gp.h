...
/* gp_create_restore_point(text) => pg_lsn */
DATA(insert OID = 6998 ( gp_create_restore_point  PGNSP PGUID 12 1 0 0 0 f f f f f f i 1 0 3220 "25" _null_ _null_ _null_ _null_ _null_ gp_create_restore_point _null_ _null_ _null_ n a ));
